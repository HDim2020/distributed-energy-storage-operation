...
/**
 * 队列消息data部分--多联机控制空调运行模式响应（设备上行）
 *
 * @author ymm
 */
@Builder
@Getter
public class VrvSetRunModeData implements IMethodService {
    /**
     * 设备ID
     */
    private String uid;
     ...
     * @return 实体对象
     */
    public static VrvSetRunModeData from(RfData rfData) {
        return VrvSetRunModeData.builder()
