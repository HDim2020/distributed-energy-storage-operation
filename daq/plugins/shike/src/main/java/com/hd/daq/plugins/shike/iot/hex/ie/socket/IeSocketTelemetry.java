...
@Builder
@Getter
public class IeSocketTelemetry implements IInformationElement {
    /**
     * 电压 2字节单位V
     */
    private int voltage;
     ...
     * @return 实体对象
     */
    public static IeSocketTelemetry decode(byte[] buf) {
        if (buf.length < 34) {
            return null;
        }
        IeSocketTelemetryBuilder builder = IeSocketTelemetry.builder()
    ...
    public int getRfDataCmdCode() {
        return DeviceCmdType.CMD_B7.getId();
    }
