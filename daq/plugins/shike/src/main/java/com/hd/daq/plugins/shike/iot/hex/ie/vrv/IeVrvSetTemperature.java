...
/**
 * 多联机控制空调温度响应信息体元素（设备上行）
 *
 * @author ymm
 */
@Builder
@Data
public class IeVrvSetTemperature implements IInformationElement {
    /**
     * 设备类型码 1字节
     */
     ...
     * @return 实体对象
     */
    public static IeVrvSetTemperature decode(byte[] buf) {
        if (buf.length < 3) {
            return null;
        }
        return IeVrvSetTemperature.builder()
    ...
    public int getCmdCode() {
        return DeviceCmdType.CMD_32.getId();
    }
