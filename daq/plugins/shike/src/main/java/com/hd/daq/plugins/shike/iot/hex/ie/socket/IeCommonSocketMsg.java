...
@Builder
@Getter
public class IeCommonSocketMsg implements IInformationElement {
    /**
     * 电压 2字节单位V
     */
    private int voltage;
     ...
     * @return 实体对象
     */
    public static IeCommonSocketMsg decode(byte[] buf) {
        if (buf.length < 34) {
            return null;
        }
        IeCommonSocketMsgBuilder builder = IeCommonSocketMsg.builder()
