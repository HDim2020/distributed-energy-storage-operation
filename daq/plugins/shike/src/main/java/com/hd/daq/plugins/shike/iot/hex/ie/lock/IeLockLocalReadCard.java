...
/**
 * 办公锁设置进入本地读卡模式响应信息体元素（设备上行）
 *
 * @author ymm
 */
@Builder
@Getter
public class IeLockLocalReadCard implements IInformationElement {
    /**
     * 设备类型 1字节
     */
     ...
     * @return 实体对象
     */
    public static IeLockLocalReadCard decode(byte[] buf) {
        if (buf.length < 7) {
            return null;
        }
        return IeLockLocalReadCard.builder()
    ...
    public int getCmdCode() {
        return DeviceCmdType.CMD_0E.getId();
    }
