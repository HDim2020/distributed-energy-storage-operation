...
import com.hd.daq.plugins.shike.iot.hex.ie.universal.IeUniversalServerSetAttribute;
...
@Builder
@Getter
public class UniversalServerSetAttributeData implements IMethodService, IServerToDeviceMessage {
    /**
     * 设备ID
     */
    private String uid;
    ...
    @SneakyThrows
    @Override
    public IeUniversalServerSetAttribute to() {
        List<Attribute> attributeList = new ArrayList<>(dataList.size());
        ...
        return IeUniversalServerSetAttribute.builder()
                .deviceTypeCode(code)
    ...
    public String getMethodName() {
        return MethodType.SET_UNIVERSAL_ATTRIBUTE.getName();
    }
}
