...
/**
 * 智能吊扇控制器配置响应数据信息体元素（设备上行）
 *
 * @author ymm
 */
@Builder
@Getter
public class IeConfigFanDevice implements IInformationElement {
    /**
     * 设备类型
     */
     ...
     * @return 实体对象
     */
    public static IeConfigFanDevice decode(byte[] buf) {
        if (buf.length != 12) {
            return null;
        }
        ...
        return IeConfigFanDevice.builder()
