...
import com.hd.daq.plugins.shike.iot.hex.ie.vrv.IeVrvServerSetRunMode;
...
/**
 * 队列请求消息params部分--多联机服务器下发控制空调运行模式
 *
 * @author ymm
 */
@Builder
@Getter
public class VrvServerSetRunModeData implements IMethodService, IServerToDeviceMessage {
    /**
     * 设备ID
     */
    private String uid;
     ...
     */
    @Override
    public IeVrvServerSetRunMode to() {
        ...
        return IeVrvServerSetRunMode.builder()
                .instruct(instruct)
    ...
    public String getMethodName() {
        return MethodType.SET_VRV_RUN_MODE.getName();
    }
}
