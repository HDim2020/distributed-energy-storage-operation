...
@Builder
@Getter
public class UniversalParamData implements IMethodService {
    /**
     * 设备ID
     */
    private String uid;
     ...
     * @return 实体对象
     */
    public static UniversalParamData from(RfData rfData) {
        ...
        return UniversalParamData.builder()
    ...
    public String getMethodName() {
        return MethodType.GET_UNIVERSAL_DEVICE_PARAM.getName();
    }
}
