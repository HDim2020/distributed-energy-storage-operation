...
/**
 * 队列消息data部分--空调伴侣对服务器下发清空电量统计的响应（设备上行）
 *
 * @author ymm
 */
@Builder
@Getter
public class AirConditionCompanionClearElectricityData implements IMethodService {
    /**
     * 设备ID
     */
    private String uid;
     ...
     */
    public static AirConditionCompanionClearElectricityData from(RfData rfData) {
        IeAirConditionCompanionTelemetryClear ie = (IeAirConditionCompanionTelemetryClear) rfData.getData();
        return AirConditionCompanionClearElectricityData.builder()
