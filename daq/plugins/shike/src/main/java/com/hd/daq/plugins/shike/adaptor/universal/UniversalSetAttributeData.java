...
@Builder
@Getter
public class UniversalSetAttributeData implements IMethodService {
    /**
     * 设备ID
     */
    private String uid;
     ...
     * @return 实体对象
     */
    public static UniversalSetAttributeData from(RfData rfData) {
        ...
        return UniversalSetAttributeData.builder()
    ...
    public String getMethodName() {
        return MethodType.GET_UNIVERSAL_ATTRIBUTE.getName();
    }
}
