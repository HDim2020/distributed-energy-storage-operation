...
/**
 * 队列消息data部分--多联机控制空调风速响应（设备上行）
 *
 * @author ymm
 */
@Builder
@Getter
public class VrvSetWindSpeedData implements IMethodService {
    /**
     * 设备ID
     */
    private String uid;
     ...
     * @return 实体对象
     */
    public static VrvSetWindSpeedData from(RfData rfData) {
        return VrvSetWindSpeedData.builder()
