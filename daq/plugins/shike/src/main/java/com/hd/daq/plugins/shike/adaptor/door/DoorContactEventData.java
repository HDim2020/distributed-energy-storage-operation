package com.hd.daq.plugins.shike.adaptor.door;
...
@Builder
@Getter
public class DoorContactEventData implements IMethodService {
    /**
     * 设备ID
     */
    private String uid;
     ...
     * @return 实体对象
     */
    public static DoorContactEventData from(RfData rfData) {
        ...
        return DoorContactEventData.builder()
