...
/**
 * 多联机查询网关上所有空调响应信息体元素（设备上行）
 *
 * @author ymm
 */
@Builder
@Data
public class IeVrvQueryAll implements IInformationElement {
    /**
     * 设备类型码 1字节
     */
     ...
     * @return 实体对象
     */
    public static IeVrvQueryAll decode(byte[] buf) {
        if (buf.length < 7) {
            return null;
        }
