...
/**
 * 队列消息data部分--大功率空调控制器对服务器下发查询功率/温度等信息的响应（设备上行）
 *
 * @author ymm
 */
@Builder
@Getter
public class AirConditionControllerQueryDeviceData implements IMethodService {
    /**
     * 设备ID
     */
    private String uid;
     ...
     */
    public static AirConditionControllerQueryDeviceData from(RfData rfData) {
        IeAirConditionControllerTelemetryQuery ie = (IeAirConditionControllerTelemetryQuery) rfData.getData();
        return AirConditionControllerQueryDeviceData.builder()
