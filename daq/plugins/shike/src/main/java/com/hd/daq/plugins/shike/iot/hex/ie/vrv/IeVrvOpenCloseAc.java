...
/**
 * 多联机打开或关闭空调响应信息体元素（设备上行）
 *
 * @author ymm
 */
@Builder
@Data
public class IeVrvOpenCloseAc implements IInformationElement {
    /**
     * 设备类型码 1字节
     */
     ...
     * @return 实体对象
     */
    public static IeVrvOpenCloseAc decode(byte[] buf) {
        if (buf.length < 3) {
            return null;
        }
        return IeVrvOpenCloseAc.builder()
