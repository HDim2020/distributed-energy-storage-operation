...
/**
 * 添加探头信息设备第一次上行信息体元素（设备上行）
 *
 * @author ymm
 */
@Builder
@Data
public class IeAddDeviceOne implements IInformationElement {
    /**
     * 设备类型 1字节
     */
     ...
     * @return 实体对象
     */
    public static IeAddDeviceOne decode(byte[] buf) {
        if (buf.length != 3) {
            return null;
        }
        return IeAddDeviceOne.builder()
