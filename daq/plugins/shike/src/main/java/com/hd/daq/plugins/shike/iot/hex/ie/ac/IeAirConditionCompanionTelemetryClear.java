...
@Builder
@Getter
public class IeAirConditionCompanionTelemetryClear implements IInformationElement {
    /**
     * 电压（2字节单位V）
     */
    private int voltage;
     ...
     * @return 实体对象
     */
    public static IeAirConditionCompanionTelemetryClear decode(byte[] buf) {
        if (buf.length != 13) {
            return null;
        }
        return IeAirConditionCompanionTelemetryClear.builder()
