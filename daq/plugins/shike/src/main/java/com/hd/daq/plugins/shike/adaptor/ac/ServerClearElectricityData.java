...
import com.hd.daq.plugins.shike.iot.hex.ie.ac.IeServerClearElectricity;
import lombok.Builder;
import lombok.Getter;

/**
 * 队列请求消息params部分--服务器下发清空电量统计
 *
 * @author ymm
 */
@Builder
@Getter
public class ServerClearElectricityData implements IMethodService, IServerToDeviceMessage {
    /**
     * 设备ID
     */
    private String uid;
     ...
     */
    @Override
    public IeServerClearElectricity to() {
        return IeServerClearElectricity.builder()
                .build();
    }
